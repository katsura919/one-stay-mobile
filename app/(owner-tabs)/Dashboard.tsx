  ...
  const StatsGrid = () => (
    <View className="px-6 mb-6">
      <View className="flex-row flex-wrap justify-between">
        <Surface className="w-[48%] mb-4 p-4 rounded-xl" elevation={2}>
          <View className="flex-row items-start justify-between mb-3">
            ...
            <View className="flex-row items-center px-2 py-1 rounded-full bg-green-100">
              ...
              <Text className="text-xs font-medium ml-1 text-green-700">
                {stats.bookings.change}
              </Text>
            </View>
          </View>
          <Text className="text-2xl font-bold text-gray-900 mb-1">
            {stats.bookings.amount}
          </Text>
        ...
        <Surface className="w-[48%] mb-4 p-4 rounded-xl" elevation={2}>
          <View className="flex-row items-start justify-between mb-3">
            ...
            <View className="flex-row items-center px-2 py-1 rounded-full bg-red-100">
              ...
              <Text className="text-xs font-medium ml-1 text-red-700">
                {stats.occupancy.change}
              </Text>
            </View>
          </View>
          <Text className="text-2xl font-bold text-gray-900 mb-1">
            {stats.occupancy.amount}
          </Text>
          <Text className="text-sm text-gray-600">Occupancy Rate</Text>
          <ProgressBar 
            progress={0.94} 
            color="#10B981" 
            className="mt-2 bg-gray-200 h-2 rounded-full" 
          />
        </Surface>
